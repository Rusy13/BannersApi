...
import (
	answer "Avito/internal/infrastructure/kafka/answer"
	reflect "reflect"
...
func (m *MockSender) sendAsyncMessage(message answer.DeleteMessage) error {
	m.ctrl.T.Helper()
...
func (m *MockSender) sendMessage(message answer.DeleteMessage) error {
	m.ctrl.T.Helper()
...
func (m *MockSender) sendMessages(messages []answer.DeleteMessage) error {
	m.ctrl.T.Helper()
